...
| `targeting/`  | Shoot-on-the-move solver and ball-flight simulation for aiming while driving                            |
...
| `MotorConfig`                       | `AbstractConfig`               | Motor-level config: [CAN](../GLOSSARY.md#can-bus) ID, inversion, current limits, [gear ratio](../GLOSSARY.md#gear-ratio), and [soft limits](../GLOSSARY.md#soft-limit) in degrees.                                                                                                                                                                                                   |
